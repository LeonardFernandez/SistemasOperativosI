...
sid32 semKeyboard;//Semaforo acceso teclado
pid32 pidKeyboard;//Guarda pid proceso que accedio a teclado

void keyboard_wait(byte a_type) //unsigned char
{
	//Creamos semaforo teclado con 1 permiso solo un proceso puede acceder
	semKeyboard =semcreate(1);	
